...
from models.ssr_unet import get_ssr_unet, get_ssr_local_unet, get_spatial_automatic_scales_ssr_unet
...
def main():
    ...
    model = get_spatial_automatic_scales_ssr_unet(channels_per_level=config_data.config.model.level_depth,
