...
from models.ssr_unet import get_weighted_spatial_automatic_scales_ssr_unet
...
def main():
    ...
    model = get_weighted_spatial_automatic_scales_ssr_unet(channels_per_level=config_data.config.model.level_depth,
